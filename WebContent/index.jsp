	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터구조&nbsp;<small>문성현</small></div>
			...
			<div class="card-body">
				...
				<p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운건 없는거 같지만.....
				<div class="row">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">데이터베이스개론&nbsp;<small>홍은지</small></div>
					<div class="col-4 text-right">
						종합<span style="color: red;">A</span>
					</div>
				</div>
			...
			<div class="card-body">
				...
				<p class="card-text">수업자체가 빡빡하긴하지만 많이 배웠습니다.
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color:red;">A</span>
